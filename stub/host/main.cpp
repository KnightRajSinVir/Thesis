...
int main() {
    ...
    for (int i = 0; i < TEST_SIZE_IN_WORDS; i++) {
        assert(c[i * 8 + 0] == 2 * i + 0 + 8);
        assert(c[i * 8 + 1] == 2 * i + 1 + 9);
        assert(c[i * 8 + 2] == 2 * i + 2 + 10);
        assert(c[i * 8 + 3] == 2 * i + 3 + 11);
        assert(c[i * 8 + 4] == 2 * i + 4 + 12);
        assert(c[i * 8 + 5] == 2 * i + 5 + 13);
        assert(c[i * 8 + 6] == 2 * i + 6 + 14);
        assert(c[i * 8 + 7] == 2 * i + 7 + 15);
    }
