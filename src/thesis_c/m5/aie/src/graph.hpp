...
public:
    ...
    simple_graph() {
        ...
        dimensions(k1.in[0]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k1.in[1]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k1.out[0]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k2.in[0]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k2.out[0]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k3.in[0]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k3.in[1]) = {BUFFER_DEPTH * SIMD_SIZE};
        dimensions(k3.out[0]) = {BUFFER_DEPTH * SIMD_SIZE};
    }
};
