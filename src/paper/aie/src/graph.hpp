...
public:
    ...
    simple_graph() {
        ...
        connect(lambda_montgomery1.out[0], lambda_montgomery3.in[0]);
        connect(lambda_montgomery2.out[0], lambda_montgomery3.in[1]);
        

        // Calculating x3 = lambda^2 - x1 - x2
        // lambda^2
        connect(lambda_montgomery3.out[0], lambda_square_montgomery1.in[0]);
        connect(lambda_montgomery3.out[0], lambda_square_montgomery1.in[1]);
        ...
        // lambda * (x1 - x3)
        connect(lambda_montgomery3.out[0], lambda_x1_x3_montgomery1.in[0]);
